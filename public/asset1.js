      ...
      d.push(p),
        a.forEach(p, function (b, S) {
          (!(a.isUndefined(b) || b === null) &&
            s.call(t, b, a.isString(S) ? S.trim() : S, y, w)) === !0 &&
            R(b, y ? y.concat(S) : [S]);
        }),
        d.pop();
    }
...
function Ie(e, t, n) {
  ...
  if (
    (s
      ? (o = s(t, n))
      : (o = a.isURLSearchParams(t) ? t.toString() : new ue(t, n).toString(r)),
    o)
  ) {
    const i = e.indexOf("#");
    i !== -1 && (e = e.slice(0, i)),
    ...
    function (t, n) {
      ...
      if (o) {
        ...
        if ((c = a.isFileList(t)) || r.indexOf("multipart/form-data") > -1) {
          ...
          return X(c ? { "files[]": t } : t, f && new f(), this.formSerializer);
        }
      }
    ...
    function (e) {
      return new Promise(function (n, r) {
        ...
        "onloadend" in h
          ...
          u && (([w, p] = V(u, !0)), h.addEventListener("progress", w)),
          f &&
            h.upload &&
            (([d, R] = V(f)),
  ...
  Xe = {
    getAdapter: (e) => {
      ...
      for (let o = 0; o < t; o++) {
        ...
        if (
          ((r = n),
          !Tn(n) && ((r = oe[(i = String(n)).toLowerCase()]), r === void 0))
        )
